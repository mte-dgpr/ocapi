# TODO: lire l'état initial (liste d'articles) et data/operations_nettoyees (par AP ordonné)
...
# TODO: si cible introuvable -> marquer l'opération "a_revoir" et attacher contexte
# TODO: sortie intermédiaire : data/journaux/articles_after_<ap>.json pour chaque AP appliqué
