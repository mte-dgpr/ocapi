...
from ocapi.types import ArreteId, NodeId, Operation, RawOperation
...
def step_detection(html_blocks: list[Document], arrete_id: ArreteId, modele: str) -> list[Operation]:
    all_ops = []
