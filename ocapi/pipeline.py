...
from ocapi.types import ArreteFile, ArticleHistory, ImageMap, Operation, Permis
...
def run_pipeline(arrete_files: list[ArreteFile])-> Permis:
    ...
    history: ArticleHistory ; arrete_files = step_resolution(operations, arrete_files)
